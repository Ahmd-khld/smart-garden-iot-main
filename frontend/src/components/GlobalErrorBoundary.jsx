    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-smart-bg dark:bg-black p-6 font-sans text-center transition-colors duration-300">
      <div className="bg-white dark:bg-gray-800 p-10 rounded-[40px] shadow-2xl border border-red-500/20 max-w-lg w-full">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button onClick={() => navigate(-1)} className="px-6 py-3 bg-smart-light/10 hover:bg-smart-light/20 text-smart-dark dark:text-white font-black text-xs uppercase tracking-widest rounded-xl transition-colors border border-smart-light/20">
            Go Back
          </button>
          <button onClick={() => window.location.reload()} className="px-6 py-3 bg-smart-light hover:bg-smart-dark text-white font-black text-xs uppercase tracking-widest rounded-xl transition-all shadow-lg hover:shadow-smart-light/40">
            Reload Page
          </button>
        </div>
      </div>
