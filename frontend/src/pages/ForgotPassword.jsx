  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-smart-bg dark:bg-black transition-colors duration-500">
      <div className="bg-white dark:bg-gray-800 p-10 rounded-[40px] shadow-2xl border border-smart-light/20 max-w-md w-full relative overflow-hidden">
        ...
        <h2 className="text-3xl font-black text-smart-dark dark:text-white text-center tracking-tighter uppercase mb-2 italic">
          Reset Access
        </h2>
        <p className="text-smart-gray dark:text-gray-400 text-center text-sm font-medium mb-8 uppercase tracking-widest">
          Forgot Password
        </p>
        ...
        <div className="mt-8 text-center">
          <Link
            to="/login"
            className="text-sm font-black text-smart-light hover:underline uppercase tracking-widest"
          >
            Back to Login
          </Link>
        </div>
