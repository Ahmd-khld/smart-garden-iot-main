    ...
    <div className="min-h-screen bg-smart-bg dark:bg-black py-12 px-6 transition-colors duration-300">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-black text-smart-dark dark:text-smart-glow mb-4 uppercase tracking-tighter italic">
            INTERACTIVE PARK MAP
          </h1>
          <p className="text-smart-gray dark:text-gray-400 font-medium">
              ...
              {Object.entries(zones).map(([name, data]) => (
                ...
                >
                  ...
                  <div className={`relative flex items-center justify-center`}>
                    <div
                      className={`absolute w-12 h-12 rounded-full ${selectedZone === name ? 'bg-smart-light animate-ping opacity-75' : 'bg-white animate-pulse opacity-40'}`}
                    ></div>
                    <div
                      className={`relative w-10 h-10 rounded-full shadow-lg flex items-center justify-center text-xl transition-all duration-300 border-2 border-white
          ...
          <div className="bg-white dark:bg-gray-800 rounded-[40px] shadow-xl p-8 border border-smart-light/20 dark:border-gray-700 h-full lg:sticky lg:top-28 transition-all">
            {selectedZone ? (
              <div className="animate-fade-in">
                <div
                  className={`${zones[selectedZone].color} dark:bg-smart-light/20 w-16 h-16 rounded-2xl flex items-center justify-center text-3xl mb-6 shadow-inner ring-4 ring-white dark:ring-gray-700`}
                >
                  {zones[selectedZone].icon}
                </div>
                <h2 className="text-3xl font-black text-smart-dark dark:text-white mb-2 uppercase italic leading-tight">
                  {selectedZone}
                </h2>
                <div className="h-1.5 w-16 bg-smart-light mb-6 rounded-full"></div>

                <p className="text-smart-gray dark:text-gray-400 font-bold uppercase text-[10px] tracking-widest mb-3">
              ...
              <div className="h-full flex flex-col items-center justify-center text-center py-12">
                <div className="w-20 h-20 bg-smart-bg dark:bg-gray-900 rounded-full flex items-center justify-center mb-6 shadow-inner">
                  <svg
                    className="w-10 h-10 text-smart-light/40 dark:text-gray-700"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
