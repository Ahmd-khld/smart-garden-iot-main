...
const AdminDashboard = () => {
  ...
  }, [isMounted, isSuperAdmin, fetchStats, fetchMonthlySales, fetchUsers, fetchSubAdmins, fetchSecurityData, activeTab, fetchPendingCashTickets]);
                ...
                <div className="flex items-center justify-center -space-x-12 px-4 h-64 relative overflow-visible">
                  ...
                  <div className="relative z-30 -ml-12 group">
                    <div className="w-56 h-56 flex items-center justify-center rounded-full bg-[#1a1f2c] shadow-[15px_0_30px_rgba(0,0,0,0.5)] transition-transform group-hover:scale-105 duration-500 overflow-hidden relative border-[10px] border-gray-700">
                      <svg className="absolute inset-0 w-full h-full transform -rotate-90 p-[-10px]" viewBox="0 0 100 100">
                          ...
                          <td className="py-4 px-2 align-middle">
                            <div className="flex justify-end gap-2 whitespace-nowrap">
                              {admin.email !== superAdminEmail ? (
                                <>
                                  <button onClick={() => router.push(`/admin/users/${admin._id}/tickets?fromTab=${activeTab}`)} className="bg-transparent border border-gray-600 px-4 py-2 rounded-xl text-[10px] font-black uppercase hover:bg-gray-700 transition">Tickets</button>
