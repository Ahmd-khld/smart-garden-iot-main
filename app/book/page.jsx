...
const pricingTiers = {
  'one-time': {
    child: parseInt(process.env.NEXT_PUBLIC_TICKET_PRICE_CHILD_DAILY) || 100,
    adult: parseInt(process.env.NEXT_PUBLIC_TICKET_PRICE_ADULT_DAILY) || 200,
    senior: parseInt(process.env.NEXT_PUBLIC_TICKET_PRICE_SENIOR_DAILY) || 150,
  },
  monthly: {
    child: parseInt(process.env.NEXT_PUBLIC_TICKET_PRICE_CHILD_MONTHLY) || 1500,
    adult: parseInt(process.env.NEXT_PUBLIC_TICKET_PRICE_ADULT_MONTHLY) || 3000,
    senior: parseInt(process.env.NEXT_PUBLIC_TICKET_PRICE_SENIOR_MONTHLY) || 2000,
  },
};
...
const BookingPage = () => {
  ...
  // wonPromoCode could be passed via query params or state in a real app, 
  // but in Next.js we might use searchParams for simplicity if needed.
  const wonPromoCode = searchParams.get('promo');
  ...
  const dailyCapacity = parseInt(process.env.NEXT_PUBLIC_DAILY_CAPACITY) || 1000;
